...
class PackageRoom extends StatefulWidget {
  @override
  _PackageRoomState createState() => _PackageRoomState();
}

Widget picturepk() {
  return Container(
    child: Image.asset('images/package.jpg'),
    width: 270,
  );
}
...
class _PackageRoomState extends State<PackageRoom> {
  @override
  int priceforone = 3500;
  double screen;
